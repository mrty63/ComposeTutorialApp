...
{
    public class EducationHealthCheck : IHealthCheck
    {
        private readonly IHttpClientFactory m_clientFactory;
        public EducationHealthCheck(IHttpClientFactory clientFactory)
        {
        ...
        CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var pingResponse = client.GetAsync($"http://webapi/Education/Ping/");
            //pingResponse.Result.IsSuccessStatusCode;
            var statusStr = "Education Controller is ";
