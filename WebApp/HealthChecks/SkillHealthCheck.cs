...
{
    public class SkillHealthCheck : IHealthCheck
    {
        private readonly IHttpClientFactory m_clientFactory;
        public SkillHealthCheck(IHttpClientFactory clientFactory)
        {
        ...
        CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var pingResponse = client.GetAsync($"http://webapi/Skills/Ping/");
            //pingResponse.Result.IsSuccessStatusCode;
            var statusStr = "Skill Controller is ";
